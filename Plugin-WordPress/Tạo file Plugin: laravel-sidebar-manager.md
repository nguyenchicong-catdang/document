# Tạo file Plugin: laravel-sidebar-manager.php
## Bạn tạo file này trong thư mục wp-content/plugins/laravel-sidebar-manager/.
```php
<?php
/*
...
```
## Phía Laravel: Cách lấy dữ liệu ra hiển thị
```php
use Corcel\Model\Option;

$sidebarHtml = Option::get('sidebar_html_content');
$sidebarName = Option::get('sidebar_name');

return view('frontend.page', compact('sidebarHtml', 'sidebarName'));
```
## Hiển thị trong Blade file:
```blade
